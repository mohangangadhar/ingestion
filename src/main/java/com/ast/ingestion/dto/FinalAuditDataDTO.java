...
public class FinalAuditDataDTO extends AbstractDTO<Integer> {
    private Integer id;
    ...
    public Double getOm_mfstactuals_amnt() {
        return this.om_mfstactuals_amnt;
    }
    ...
    public Double getOm_invrcestimates_amnt() {
        return this.om_invrcestimates_amnt;
    }
    ...
    public Double getOm_mfstrcestimates_amnt() {
        return this.om_mfstrcestimates_amnt;
    }
    ...
    public String getMfst_bill_to_company() {
        return this.mfst_bill_to_company;
    }
    ...
    public String getMfst_ship_from_company() {
        return this.mfst_ship_from_company;
    }
    ...
    public String getMfst_consignee_name() {
        return this.mfst_consignee_name;
    }
    ...
    public String getMfst_ship_from_state() {
        return this.mfst_ship_from_state;
    }
    ...
    public String getMfst_delivery_state() {
        return this.mfst_delivery_state;
    }
    ...
    public String getMfst_delivery_date() {
        return this.mfst_delivery_date;
    }
    ...
    public String getMfst_delivery_pincode() {
        return this.mfst_delivery_pincode;
    }
